...
public class TestCuenta {
	...
	public static void main(String[] args) {
		...
		double tipo;
		double importe;
		// vamos a crear un objecto de nuestra clase Cuenta usando el constructor sin
		// parametros.
		...
		Cuenta cuenta2 = new Cuenta("Anallely Hernandez", "12346567", 12.3, 5000);
		...
		cuenta3.trasferencia(cuenta2, 2000);
